...
using TimsyDev.LambdaFunction.Boilerplate.Config;
using TimsyDev.LambdaFunction.Boilerplate.Extensions;
using TimsyDev.LambdaFunction.Boilerplate.FunctionServices;
using TimsyDev.LambdaFunction.Boilerplate.Models;

// Assembly attribute to enable the Lambda function's JSON input to be converted into a .NET class.
[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.SystemTextJson.DefaultLambdaJsonSerializer))]

namespace TimsyDev.LambdaFunction.Boilerplate;
...
public class Function
{
    ...
    public async Task<APIGatewayProxyResponse> FunctionHandlerAsync(APIGatewayProxyRequest request, ILambdaContext context)
    {
        ...
        return APIGatewayProxyResponseWrapper.Build(200);
    }
    ...
    ///     "function-handler": "TimsyDev.LambdaFunction.Boilerplate::TimsyDev.LambdaFunction.Boilerplate.Function::ExampleFunctionHandlerAsync"
    /// </summary>
